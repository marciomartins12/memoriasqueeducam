...
const ProgressoCacaPalavras = sequelize.define('ProgressoCacaPalavras', {
  id: {
  ...
  tableName: 'progresso_caca_palavras',
  timestamps: true,
  createdAt: 'criado_em',
...
ProgressoCacaPalavras.belongsTo(Dispositivo, {
  foreignKey: 'dispositivo_id',
  as: 'dispositivo'
});

module.exports = ProgressoCacaPalavras;
