(function () {
  ...
  var CONTEUDOS = {
    'sao-felipe': {
      ...
      localizacao: [
        "A comunidade São Felipe está localizada no município de Presidente Sarney, estado do Maranhão (MA), região Nordeste do Brasil). Seu território integra a paisagem típica do leste maranhense, com áreas de vegetação, roças, cursos d'gua e estradas vicinais que a conectam ao restante do município e aos povoados vizinhos, incluindo a comunidade de Santa Rita.",
      ...
      fotos: [
        "Acervo visual da comunidade São Felipe: as fotos da comunidade reúnem registros dos espaços coletivos, como a sede, a escola, os terreiros e as áreas de convivência; das paisagens do entorno, com roças, palmeiras e cursos d'gua; e das atividades tradicionais e momentos de festa e celebração.",
    ...
    'santa-rita': {
      ...
      localizacao: [
        "A comunidade Santa Rita está localizada no município de Presidente Sarney, estado do Maranhão (MA), integrando a região do leste maranhense. Seu território compreende áreas de vegetação nativa, roças tradicionais, cursos d'gua e estradas vicinais que a conectam à sede do município e à vizinha comunidade de São Felipe.",
